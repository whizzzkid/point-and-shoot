...
These guides walk through Point and Shoot tasks in reading order, from installing the extension to
agent handoff and release:

- [Get started](getting-started.md) — install the extension from your browser store, capture a
  multi-page session, and export it.
...
- [Build Point and Shoot from source](building-from-source.md) — clone the repository, build both
  targets, and load the unpacked extension in Chrome or Firefox.
